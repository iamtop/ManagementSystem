/*
 Basic Primitives orgDiagram v2.0.19
...
primitives.common.Connector.prototype.draw=function(a,b,c){var d,e,f,g=[],h=[],j,i,k,l,n,m,p,r;j=6*this.lineWidth;var q=4*this.lineWidth;r=1.5*q;var s,t,v=0,w=0,u,a=(new primitives.common.Rect(a)).offset(this.offset),b=(new primitives.common.Rect(b)).offset(this.offset);l=[];switch(this.connectorShapeType){case 1:l=[-r/2,r/2];break;case 0:l=[0]}this.transform=new primitives.common.Transform;this.transform.size=this.panelSize;this.transform.setOrientation(this.orientationType);this.transform.transformRect(a.x,
...
d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),(p?f.top():f.bottom())+n,e.x,e.y+n));l=s.width<2*(f.width/5)?this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),p?f.top():f.bottom()),e,0.5):new primitives.common.Point(d.x,p?f.top():f.bottom());t=new primitives.common.Rect(l.x+(m?r:-s.width-r),p?l.y-s.height-j:l.y+j,s.width,s.height)}else{i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x,d.y+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+
n*(p!=m?1:-1),(p?f.top():f.bottom())+n,f.horizontalCenter()+n*(p!=m?1:-1),f.verticalCenter()+n)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter()+n*(p!=m?1:-1),(p?f.bottom():f.top())+n,e.x,e.y+n));t=new primitives.common.Rect(f.horizontalCenter()+(p!=m?r:-(r+s.width)),f.verticalCenter()-s.height/2,s.width,s.height)}else if(a.verticalCenter()<b.top()||a.verticalCenter()>b.bottom()){m=a.x<u.width/2;d=new primitives.common.Point(m?a.right():a.left(),a.verticalCenter());e=new primitives.common.Point(m?
...
(m?r/2:-r/2-s.width),l.y-s.height/2,s.width,s.height)}else{d=new primitives.common.Point(a.horizontalCenter(),a.top());e=new primitives.common.Point(b.horizontalCenter(),b.top());w=v=1;f=new primitives.common.Rect(d,e);f.offset(0,7*j,0,0);m=d.x<e.x;i=0;for(k=l.length;i<k;i+=1)n=l[i],g.push(new primitives.common.MoveSegment(d.x+n,d.y)),g.push(new primitives.common.QuadraticArcSegment(f.horizontalCenter(),f.top()-n*(m?-1:1),b.horizontalCenter()-n,b.top()));l=this._quadraticBezierPoint(d,new primitives.common.Point(f.horizontalCenter(),
f.top()),e,0.5);t=new primitives.common.Rect(l.x-s.width/2,l.y-(this.labelOffset+s.height),s.width,s.height)}if(0<g.length){this.transform.transformSegments(g,!0);switch(this.connectorShapeType){case 1:l=g[g.length/2-1];m=Math.atan2(l.cpY-l.y,l.cpX-l.x);h=h.concat(this._getArrow(l.x,l.y,j,q,m));m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),q);l.x=m.x;l.y=m.y;r=g[g.length/2];l=g[g.length/2+1];m=Math.atan2(l.cpY-r.y,l.cpX-r.x);h=h.concat(this._getArrow(r.x,
r.y,j,q,m));m=this._offsetPoint(new primitives.common.Point(r.x,r.y),new primitives.common.Point(l.cpX,l.cpY),q);r.x=m.x;r.y=m.y;break;case 0:l=g[g.length-1],m=Math.atan2(l.cpY-l.y,l.cpX-l.x),h=h.concat(this._getArrow(l.x,l.y,j,q,m)),m=this._offsetPoint(new primitives.common.Point(l.x,l.y),new primitives.common.Point(l.cpX,l.cpY),q),l.x=m.x,l.y=m.y}j={};null!==this.borderColor&&(j.borderColor=this.color);j.lineWidth=this.lineWidth;j.lineType=this.lineType;this.m_graphics.polyline(g,j);g={opacity:1};
...
h.actualPosition.bottom()),p.isSquared=!0,p.highlightPath=h.partnerHighlightPath,p.connectorStyleType=h.partnerHighlightPath?2:0,f.push(p);0<f.length&&(f.sort(function(a,b){return a.x-b.x}),0==c.visualChildren.length&&(l=(f[0].x+f[f.length-1].x)/2),this._drawTopConnectors(b,l,n,f,!0,a))}if(0<c.visualChildren.length){f=[];k=!1;g=c.visualChildren;for(i=0;i<g.length;i+=1)if(h=this._treeItems[g[i]],j=this._treeLevels[h.level],q=b.getPolyline(h.highlightPath?2:1).segments,h.connectorPlacement&8)j=this._treeItems[j.treeItems[h.levelPosition-
1]],this.transform.transformPoints(h.actualPosition.x,h.actualPosition.verticalCenter(),j.actualPosition.right(),h.actualPosition.verticalCenter(),!0,this,function(a,b,c,d){q.push(new primitives.common.MoveSegment(a,b));q.push(new primitives.common.LineSegment(c,d))});else if(h.connectorPlacement&2)j=this._treeItems[j.treeItems[h.levelPosition+1]],this.transform.transformPoints(h.actualPosition.right(),h.actualPosition.verticalCenter(),j.actualPosition.x,h.actualPosition.verticalCenter(),!0,this,
function(a,b,c,d){q.push(new primitives.common.MoveSegment(a,b));q.push(new primitives.common.LineSegment(c,d))});else if(h.connectorPlacement&1&&!e){j=!0;if(a)switch(h.actualVisibility){case 2:case 3:j=r}p=new primitives.orgdiagram.ConnectorPoint(h.actualPosition.horizontalCenter()+0,h.actualPosition.top());p.isSquared=j;p.connectorStyleType=h.highlightPath?2:1;f.push(p);k=k||p.isSquared}!e&&0<f.length&&(m=this._drawTopConnectors(b,l,d.connectorShift,f,k,a),this.transform.transformPoints(l,n,l,d.connectorShift,
!0,this,function(a,d,e,g){q=b.getPolyline(m).segments;this.showElbowDots&&(0!=this.options.elbowType&&0<c.partners.length)&&q.push(new primitives.common.DotSegment(a-1,d-1,2,2,1));q.push(new primitives.common.MoveSegment(a,d));q.push(new primitives.common.LineSegment(e,g));this.showElbowDots&&(0!=this.options.elbowType&&1<f.length)&&q.push(new primitives.common.DotSegment(e-1,g-1,2,2,1))}))}};
...
primitives.common.optimizeReferences=function(a,b){var c={},d=[],e={},f={},g,h,j,i,k,l,n,m,p,r,q;for(g in a)a.hasOwnProperty(g)&&(h=a[g],j=new primitives.common.ReferenceItem,h.sort(),j.key=h.join(","),j.name=g,j.targets=h.slice(0),j.actualTargets=h.slice(0),j.level=0,f[j.name]=j);for(;!primitives.common.isEmptyObject(f);){h={};j=primitives.common.getReferencesGraph(f);for(g in f)if(f.hasOwnProperty(g)&&(i=f[g],d.push(i),!i.processed))for(n in l=primitives.common.getGraphSpanningTree(j,g,function(a,
b){return a.weight>b.weight?1:a.weight==b.weight?b.difference-a.difference:-1}),l)if(l.hasOwnProperty(n)){f[n].processed=!0;m=l[n];i=0;for(k=m.length;i<k;i+=1)p=m[i],f[p].processed=!0,r=j[n][p],1<r.weight&&(g=r.items.join(","),q=null,e.hasOwnProperty(g)?q=e[g]:(q=new primitives.common.ReferenceItem,q.name=b(),q.key=g,q.actualTargets=r.items.slice(0),q.targets=r.items.slice(0),e[q.key]=q,h[q.name]=q),primitives.common.addGroup(f[n],q),primitives.common.addGroup(f[p],q))}f=h}i=0;for(k=d.length;i<k;i+=
...
primitives.common.stackSegments=function(a,b){var c=0,d,e,f,g,h,j,i,k=[],l,n,m,p,r,q,s={};a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});g=0;for(h=a.length;g<h;g+=1){f=a[g];e=d=0;m=f.startIndex;s[m]=d+1;p=f.endIndex;s[p]=e;i=k.length;if(0<i){l=[];q=r=!1;for(j=0;j<i;j+=1)n=k[j],n<m?(l.push(n),d=s[n],e=s[n]):n<p?(r||(l.push(m),r=!0),d=Math.max(d,s[n]),e=s[n]):(r||(l.push(m),r=!0),q||(l.push(p),q=!0,s[m]=d+1,s[p]=e),l.push(n));r||(l.push(m),r=!0);q||(l.push(p),q=!0,s[m]=
...
Math.max(isNaN(c)?0:c,this.maximumFamItemId));l={};p={};t=[];for(n in this._famItems)if(this._famItems.hasOwnProperty(n)){d=this._famItems[n];r={};f=d.itemConfig.parents;if(null!=f){a=0;for(b=f.length;a<b;a+=1)k=f[a],this._famItems.hasOwnProperty(k)&&(k!=d.id&&!r.hasOwnProperty(k))&&(r[k]=!0,e=this._famItems[k],e.children.push(d.id),e.logicalChildren.push(d.id),d.logicalParents.push(k),d.parents.push(k),l.hasOwnProperty(k)||(l[k]={}),l[k][n]=k,p.hasOwnProperty(n)||(p[n]={}),p[n][k]=n)}e=d.itemConfig.spouses;
null!=e&&0<e.length&&t.push(d)}a=0;for(b=t.length;a<b;a+=1){v=t[a];r={};r[v.id]=!0;w=[v.id];e=v.itemConfig.spouses;c=0;for(d=e.length;c<d;c+=1)f=e[c],this._famItems.hasOwnProperty(f)&&!r.hasOwnProperty(f)&&(r[f]=!0,w.push(f));u=!1;e=0;for(f=v.logicalChildren.length;e<f;e+=1)if(c=this._famItems[v.logicalChildren[e]],c.logicalParents.length==w.length){x=!0;d=0;for(g=c.logicalParents.length;d<g;d+=1)if(!r.hasOwnProperty(c.logicalParents[d])){x=!1;break}if(x){u=!0;break}}if(!u){this.maximumFamItemId+=
1;r=new primitives.famdiagram.FamilyItem({id:this.maximumFamItemId,isVisible:!1,isActive:!1,hideParentConnection:!0,hideChildrenConnection:!0});this._famItems[r.id]=r;c=0;for(d=w.length;c<d;c+=1)f=w[c],e=this._famItems[f],e.logicalChildren.push(r.id),e.children.push(r.id),r.logicalParents.push(e.id),r.parents.push(e.id),l.hasOwnProperty(e.id)||(l[e.id]={}),l[e.id][r.id]=e.id,p.hasOwnProperty(r.id)||(p[r.id]={}),p[r.id][e.id]=r.id}}this._sortItemsBylevelsTopo(this._famItems);for(m in this._famItems)this._famItems.hasOwnProperty(m)&&
(d=this._famItems[m],d.logicalChildren.sort(function(a,b){return q._famItems[a].level-q._famItems[b].level}),d.logicalParents.sort(function(a,b){return q._famItems[b].level-q._famItems[a].level}));for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(this._famItems[m].level=null);this._sortItemsBylevelsSmart(this._famItems);if(0<this.options.annotations.length){for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(d=this._famItems[m],d.logicalChildren.length=0,d.logicalParents.length=0,
d.children.length=0,d.parents.length=0);c={};a=0;for(b=this.options.annotations.length;a<b;a+=1)s=this.options.annotations[a],3==s.annotationType&&(c.hasOwnProperty(s.fromItem)?c[s.fromItem].push(s):c[s.fromItem]=[s]);for(j in c)if(c.hasOwnProperty(j)){b=c[j];b.sort(function(a,b){return b.toItems.length-a.toItems.length});for(a=0;a<b.length;a+=1)s=b[a],this._addLabelAnnotation(l,s.fromItem,s.toItems,function(){var a=null;q.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,
isVisible:!0,isActive:!1,itemConfig:s,levelGravity:1});q._famItems[a.id]=a;return a.id}),this._addLabelAnnotation(p,s.fromItem,s.toItems,function(){var a=null;q.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,isVisible:!0,isActive:!1,itemConfig:s,levelGravity:2});q._famItems[a.id]=a;return a.id})}for(n in this._famItems)if(this._famItems.hasOwnProperty(n)){d=this._famItems[n];j=l[d.id];if(null!=j)for(i in j)j.hasOwnProperty(i)&&(e=d,j[i]!=d.id&&(e=this._famItems[j[i]]),
c=this._famItems[i],p.hasOwnProperty(i)&&p[i].hasOwnProperty(d.id)&&p[i][d.id]!=i&&(c=this._famItems[p[i][d.id]]),e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id));f=p[d.id];if(null!=f)for(k in f)f.hasOwnProperty(k)&&(e=this._famItems[k],c=d,f[k]==d.id&&!l.hasOwnProperty(k)&&(e.logicalChildren.push(c.id),c.logicalParents.push(e.id),e.children.push(c.id),c.parents.push(e.id)))}}a={};for(m in this._famItems)this._famItems.hasOwnProperty(m)&&(a[m]=this._famItems[m].logicalChildren.slice(0));
a=primitives.common.optimizeReferences(a,function(){var a;q.maximumFamItemId+=1;a=new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,isVisible:!1,isActive:!1,levelGravity:2});q._famItems[a.id]=a;return a.id});for(m in a)a.hasOwnProperty(m)&&(j=a[m],q._famItems[m].logicalChildren=j);this._eliminateManyToMany(this._famItems,function(){q.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,isVisible:!1,isActive:!1,itemConfig:new primitives.famdiagram.ItemConfig({id:q.maximumFamItemId}),
levelGravity:2})});this._resortItemsBylevels(this._famItems);this._fillInItems(this._famItems,function(){q.maximumFamItemId+=1;return new primitives.famdiagram.FamilyItem({id:q.maximumFamItemId,levelGravity:2,isVisible:!1,isActive:!1})});this._setLogicalParents(this._famItems);if(this._debug)for(m in this._famItems)if(this._famItems.hasOwnProperty(m)){d=this._famItems[m];j=d.logicalChildren;for(a=0;a<j.length;a+=1){b=j[a];b=this._famItems[b];if(0>b.logicalParents.indexOf(m))throw"Family tree is broken. Logical child does not reference logical parent.";
...
new primitives.famdiagram.ItemConfig;a=null;for(b=0;null!=(a=this._findLargestRoot());)m=new primitives.famdiagram.Family(b),this._extractOrgChart(m,this._famItems[a]),this._families.push(m),b+=1;l=[];n={};if(0<this._families.length){a=0;for(b=this._families.length;a<b;a+=1){m=this._families[a];c=0;for(d=m.links.length;c<d;c+=1)j=m.links[c],i=this._famItems[j.fromItem].familyId,k=this._famItems[j.toItem].familyId,i!=k&&(h.hasOwnProperty(i)||(h[i]={}),h[i].hasOwnProperty(k)||(h[i][k]=0),h[i][k]+=1,
h.hasOwnProperty(k)||(h[k]={}),h[k].hasOwnProperty(i)||(h[k][i]=0),h[k][i]+=1),this._families[k].backLinks.push(new primitives.famdiagram.FamLink(j.toItem,j.fromItem))}for(;l.length<this._families.length;){a=0;for(b=this._families.length;a<b;a+=1)if(m=this._families[a],!n.hasOwnProperty(m.id))if(i=primitives.common.getGraphSpanningTree(h,m.id,function(a,b){return a-b}),i.hasOwnProperty(m.id)){this._countNumberOfSubFamilies(m.id,i);l.push(m.id);n[m.id]=!0;j=i[m.id];c=0;for(d=j.length;c<d;c+=1){m=this._getFamilyAndItsSubFamilies(j[c],
i);e=0;for(f=m.length;e<f;e+=1)k=m[e],l.push(k),n[k]=!0}}else l.push(m.id),n[m.id]=!0}}this.maximumFamItemId+=1;this._orgItemRoot=this._createOrgItem(this.maximumFamItemId,null,null,this.minimumLevel-1,null);this._orgItemRoot.hideParentConnection=!0;this._orgItemRoot.hideChildrenConnection=!0;this._orgItemRoot.title="internal root";this._orgItemRoot.isVisible=!1;this._orgItemRoot.isActive=!1;n={};a=0;for(b=l.length;a<b;a+=1){m=this._families[l[a]];i={};k=this._orgItemRoot;d=0;h=m.links.concat(m.backLinks);
for(c=0;c<h.length;c+=1)if(j=h[c],p=this._orgItems[j.toItem],j=this._orgItems[j.fromItem],!0==n[p.familyId]){for(j=m.items[0];p.level>=j.level;)p=this._orgItems[p.parent];i[p.id]=i.hasOwnProperty(p.id)?i[p.id]+1:1;d<i[p.id]&&(k=p,d=i[p.id])}this._attachFamilyToOrgChart(k,m);n[m.id]=!0}a=this._getExtraGravity();b=this._getGrandChildren();this._balanceChildrenForItem(a,b,this._orgItemRoot)}};
...
primitives.famdiagram.Controller.prototype._balanceChildrenForItem=function(a,b,c){var d,e,f,g,h,j,i,k,l,n,m,p=[c],r,q=[],s,t,v,w,u;for(c.childIndex=0;0<p.length;){c=0;for(i=p.length;c<i;c+=1)if(r=p[c],d={},e={},this._orgItemChildren.hasOwnProperty(r.id)){t=this._orgItemChildren[r.id];l=null;s=[];if(0<t.length){f=0;for(g=t.length;f<g;f+=1){k=t[f];null==l&&(l=k);e[k.id]={};if(a.hasOwnProperty(k.id))for(w in m=a[k.id],m)if(m.hasOwnProperty(w)){u=m[w];e[k.id][w]={};h=0;for(j=u.length;h<j;h+=1)n=u[h],
n=n.commonParent==r.id?n.toParent:this._orgItems[n.fromParent].childIndex<this._orgItems[n.toParent].childIndex?"__right__":"__left__",k.id!=n&&(d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(n)||(d[k.id][n]=0),d[k.id][n]+=1,null==e[k.id][w][n]&&(e[k.id][w][n]=0),e[k.id][w][n]+=1)}0<f&&(d.hasOwnProperty(l.id)||(d[l.id]={}),d[l.id].hasOwnProperty(k.id)||(d[l.id][k.id]=0),d.hasOwnProperty(k.id)||(d[k.id]={}),d[k.id].hasOwnProperty(l.id)||(d[k.id][l.id]=0))}if(null!=l){f=0;l=l.id;for(v in d)if(d.hasOwnProperty(v)){g=
d[v];h=0;for(n in g)g.hasOwnProperty(n)&&(h+=g[n]);h>f&&(l=v,f=h)}d=primitives.common.getGraphGrowthSequence(d,l,function(a){return a});l=this._balanceItems(d,"__left__","__right__",e,b);e=0;for(d=l.length;e<d;e+=1)f=this._orgItems[l[e]],f.childIndex=e,s.push(f)}if(this._debug&&!primitives.common.compareArrays(this._orgItemChildren[r.id],s,function(a){return a.id}))throw"Balancing of items is broken! Incoming vs. outgoing arrays of items mismatch.";this._orgItemChildren[r.id]=s}q=q.concat(t)}p=q;
q=[]}};
primitives.famdiagram.Controller.prototype._balanceItems=function(a,b,c,d,e){var f=[],g,h,j,i,k,l,n,m,p,r,q,s,t,v,w,u,x,z,A,y;h=new primitives.famdiagram.Slots;h.add(new primitives.famdiagram.Slot(b));h.add(new primitives.famdiagram.Slot(null));h.add(new primitives.famdiagram.Slot(c));j=0;h.loop(function(a){j+=1;a.position=j});for(g=0;g<a.length;g+=1)if(i=a[g],i!=b&&i!=c)for(x in p=m=n=l=k=null,h.loop(function(a){var b,c,f,g;if(null==a.itemId){v=e[i];t=s=q=r=0;for(b in a.crossings)a.crossings.hasOwnProperty(b)&&(v&&
null!=v[b]&&(r+=a.crossings[b]*v[b]),t+=a.crossings[b]);for(b in d[i])if(d[i].hasOwnProperty(b))for(c in f=d[i][b],f)f.hasOwnProperty(c)&&(g=h.getSlot(c),null!=g&&(g.position<a.position?(r+=(a.left[b]||0)-(g.left[b]||0),s+=Math.abs(g.balance+1)):(r+=(a.right[b]||0)-(g.right[b]||0),s+=Math.abs(g.balance-1)),q+=Math.abs(g.position-a.position)));if(null==l||l>r||l==r&&(n>q||n==q&&(m>s||m==s&&p>t)))l=r,k=a,n=q,m=s,p=t}}),w=k.clone(),u=k.clone(),u.itemId=i,h.insertBefore(k,w),h.insertBefore(k,u),j=u.position=
