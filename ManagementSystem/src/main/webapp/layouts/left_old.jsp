...
<div class="easyui-accordion"
	...
	<div class="menuItem" title='3D Marker Icon' data-options="iconCls:''"
		...
		<li><a data-options="plain:true" href="javascript:void(0)"
				...
				onclick="indexTabsAddTab('href',{title:'Main Frame ',url:'${ctx}/marker',iconCls:'icon-user_gray'})">
				  Main Frame
			</a></li>
			...
			<li>Color<!-- <a id="colorId" data-options="plain:true" href="javascript:void(0)"
				class="user easyui-linkbutton" onclick="colorpicker();"  >
				  Color
			</a> --><input type='color' name='color2' value='#3355cc' id="coloidval" /></li>
