...
<link rel="stylesheet" type="text/css" href="${ctx}/static/js/plugins/jquery-easyui-1.3.4/jquery-ui.css">

<link rel="stylesheet" type="text/css" href="${ctx}/static/styles/default.css" />

<link rel="stylesheet" type="text/css" href="${ctx}/static/js/plugins/jquery-easyui-1.3.4/portal.css">

<link rel="stylesheet" type="text/css" href="${ctx}/static/js/rotation/jquery.ui.rotatable.css"></link>

<link rel="stylesheet" href="${ctx }/static/js/plugins/uploadify/uploadify.css" type="text/css">
...
<script type="text/javascript" src="${ctx}/static/js/plugins/jquery-easyui-1.3.4/plugins/datagrid-detailview.js"></script>
<script type="text/javascript" src="${ctx}/static/js/plugins/jquery-easyui-1.3.4/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="${ctx}/static/js/plugins/jquery-easyui-1.3.4/jquery.portal.js"></script>

<script type="text/javascript" src="${ctx}/static/js/extAppJs/extEasyUI.js"></script>
<script type="text/javascript" src="${ctx}/static/js/extAppJs/extJquery.js"></script>
