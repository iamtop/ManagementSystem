		...
		<div
			...
			<form id="authority_list_searchForm" method="post"
				...
				<table class="search_table" style="width: 100%;">
					<tr>
						    						<th><spring:message code="authority_subId" /></th>
						<td><input type="text" name="search_EQ_subId"
							value="${ param.search_EQ_subId}"
							id="search_EQ_subId" /></td>   						<th><spring:message code="authority_roleCode" /></th>
						<td><input type="text" name="search_EQ_roleCode"
							value="${ param.search_EQ_roleCode}"
							id="search_EQ_roleCode" /></td>      						<th style="width:20%;">&nbsp;<a href="javascript:void(0);"
...
<script type="text/javascript">
	...
	var authority_list_datagrid_columns = [ [
	                    		{field : 'id',title : '编号',width : 150,checkbox : true,align:'center'},
	    	          					{field : 'deptId',title : '<spring:message code="authority_deptId" />',width : 150,align:'center'},
			          					{field : 'subId',title : '<spring:message code="authority_subId" />',width : 150,align:'center'},
			          					{field : 'roleCode',title : '<spring:message code="authority_roleCode" />',width : 150,align:'center'},
			          					{field : 'pId',title : '<spring:message code="authority_pId" />',width : 150,align:'center'},
