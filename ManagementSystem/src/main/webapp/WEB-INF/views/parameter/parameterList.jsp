		...
		parent.$.messager.confirm('确认', '是否确定删除该记录?', function(r) {
			if (r) {
				$.post(deleteUrl, {
					...
					if (result.success) {
						parameter_list_listDatagrid.treegrid('reload',result.data); // reload the user data
						$.messager.show({ 
							title : '提示',
							msg : result.message
						});
	...
	<div data-options="fit:true,border:false" class="easyui-panel">
		<div class="easyui-layout" data-options="fit:true">
			...
			<div id="parameter_list_toolbar" style="display: none;">
				<a href="Javascript:parameter_list_addForm('增加参数',parameter_list_CREATE_URL,'parameter_form_inputForm','0');"
