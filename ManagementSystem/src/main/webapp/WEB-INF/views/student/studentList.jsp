		...
		<div
			...
			<form id="student_list_searchForm" method="post"
				...
				<table class="search_table" style="width: 100%;">
					<tr>
						    						<th><spring:message code="student_brId" /></th>
						<td><input type="text" name="search_EQ_brId"
							value="${ param.search_EQ_brId}"
							id="search_EQ_brId" /></td>   						<th><spring:message code="student_subId" /></th>
...
<script type="text/javascript">
	...
	var student_list_datagrid_columns = [ [
	                    		{field : 'id',title : '编号',width : 150,checkbox : true,align:'center'},
			          					...
			          					{field : 'brId',title : '<spring:message code="student_brId" />',width : 150,align:'center'},
			          					{field : 'subId',title : '<spring:message code="student_subId" />',width : 150,align:'center'},
