package com.infotop.management.personal.web;


import com.infotop.management.personal.service.PersonalService;
...
/**
 * PersonalAction
 * $Id: PersonalAction.java,v 0.0.1 2015-03-20 14:49:30  $
 */
@Controller
...
public class PersonalController extends BasicController {
	...
	public DataGrid findList(
		...
		try {
			...
			if (user != null) {
				...
				dataGrid = personalService.dataGrid(searchParams, pageNumber,
						rows, sortType, order);
			} else {
				logger.log(this.getClass(),Logger.ERROR_INT,"登陆帐号无效!","",null);
			}
	 ...
	 public String createForm(Model model) {
	     ShiroUser su = super.getLoginUser();
			...
			if (user != null) {
			     ...
			     model.addAttribute("personal", entity);
	 ...
	 */
	 ...
	 @ResponseBody
	 public Message create(@Valid Personal personal, RedirectAttributes redirectAttributes) {
		try {
			ShiroUser su = super.getLoginUser();
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
	 ...
	 */
	 @RequestMapping(value = "update/{id}", method = RequestMethod.GET)
	    public String updateForm(@PathVariable("id") Long id, Model model) {
			...
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
				Personal entity = personalService.get(id); 
		        model.addAttribute("personal", entity);
	 ...
	 */
	 ...
	 @ResponseBody
	    public Message update(@Valid @ModelAttribute("preloadPersonal") Personal personal,
	 ...
	 @RequestMapping(value = "view/{id}", method = RequestMethod.GET)
	    public String view(@PathVariable("id") Long id, Model model) {
			...
			if (user != null) {
		 	...
		 	return "personal/personalView";
	    }
	 
	 
	   @ModelAttribute("preloadPersonal")
	    public Personal getPersonal(@RequestParam(value = "id", required = false) Long id) {
	        if (id != null) {
