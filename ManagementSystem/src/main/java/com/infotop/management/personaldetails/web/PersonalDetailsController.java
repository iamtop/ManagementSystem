package com.infotop.management.personaldetails.web;
 ...
 * $Id: PersonalDetailsAction.java,v 0.0.1 2015-03-31 10:54:01  $
 */
@Controller
@RequestMapping(value = "/personaldetails")
public class PersonalDetailsController extends BasicController {
	...
	public DataGrid findList(
		...
		try {
			...
			if (user != null) {
				...
				dataGrid = personaldetailsService.dataGrid(searchParams, pageNumber,
						rows, sortType, order);
			} else {
				logger.log(this.getClass(),Logger.ERROR_INT,"登陆帐号无效!","",null);
			}
	 ...
	 public String createForm(Model model) {
	     ShiroUser su = super.getLoginUser();
			...
			if (user != null) {
			     ...
			     model.addAttribute("personaldetails", entity);
			     model.addAttribute("action", "create");
			} else {
				logger.log(this.getClass(),Logger.ERROR_INT,"登陆帐号无效!","",null);
				return "redirect:/login";
			}
	     return "personaldetails/personaldetailsForm";
	 }
	 ...
	 */
	 ...
	 @ResponseBody
	 public Message create(@Valid PersonalDetails personaldetails, RedirectAttributes redirectAttributes) {
		try {
			ShiroUser su = super.getLoginUser();
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
	 ...
	 */
	 @RequestMapping(value = "update/{id}", method = RequestMethod.GET)
	    public String updateForm(@PathVariable("id") Long id, Model model) {
			...
			User user = accountService.findUserByLoginName(su.getLoginName());
			if (user != null) {
				PersonalDetails entity = personaldetailsService.get(id); 
		        model.addAttribute("personaldetails", entity);
	 ...
	 */
	 ...
	 @ResponseBody
	    public Message update(@Valid @ModelAttribute("preloadPersonalDetails") PersonalDetails personaldetails,
	 ...
	 @ResponseBody
	    public Message delete(@RequestParam(value = "ids") List<Long> ids,
	     ...
	     try {
				...
				User user = accountService.findUserByLoginName(su.getLoginName());
				if (user != null) {
					personaldetailsService.delete(ids);
					msg.setSuccess(true);
	 ...
	 @RequestMapping(value = "view/{id}", method = RequestMethod.GET)
	    public String view(@PathVariable("id") Long id, Model model) {
			...
			if (user != null) {
		 	...
		 	return "personaldetails/personaldetailsView";
	    }
	 
	 
	   @ModelAttribute("preloadPersonalDetails")
	    public PersonalDetails getPersonalDetails(@RequestParam(value = "id", required = false) Long id) {
	        if (id != null) {
	            return personaldetailsService.get(id);
	        }
	        return null;
	    }
